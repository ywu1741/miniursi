...
*The placement of some parameters in this file are not exactly the same as what you will see in your project since this file contains information for multiple animal pose estimation.*
